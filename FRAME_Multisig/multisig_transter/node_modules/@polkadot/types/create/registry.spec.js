...
describe('TypeRegistry', () => {
  ...
  it('hashes via blake2 by default', () => {
    expect(registry.hash((0, _util.u8aToU8a)('abc')).toU8a()).toEqual(new Uint8Array([189, 221, 129, 60, 99, 66, 57, 114, 49, 113, 239, 63, 238, 152, 87, 155, 148, 150, 78, 59, 177, 203, 62, 66, 114, 98, 200, 192, 104, 213, 35, 25]));
  });
  it('hashes via override hasher', () => {
    registry.setHasher(_utilCrypto.keccakAsU8a);
    expect(registry.hash((0, _util.u8aToU8a)('test value')).toHex()).toEqual('0x2d07364b5c231c56ce63d49430e085ea3033c750688ba532b24029124c26ca5e');
    registry.setHasher();
    expect(registry.hash((0, _util.u8aToU8a)('abc')).toU8a()).toEqual(new Uint8Array([189, 221, 129, 60, 99, 66, 57, 114, 49, 113, 239, 63, 238, 152, 87, 155, 148, 150, 78, 59, 177, 203, 62, 66, 114, 98, 200, 192, 104, 213, 35, 25]));
  });
});