...
describe('UInt', () => {
  ...
  it('converts to JSON representation based on size', () => {
    expect(new _UInt.default(registry, '0x12345678', 64).toJSON()).toEqual(0x12345678);
    expect(new _UInt.default(registry, '0x1234567890', 64).toJSON()).toEqual(0x1234567890);
    expect(new _UInt.default(registry, '0x1234567890abcdef', 64).toJSON()).toEqual('0x1234567890abcdef');
  });
  describe('eq', () => {
