...
describe('CodecMap', () => {
  describe('decoding', () => {
    const testDecode = (type, input, output) => it(`can decode from ${type}`, () => {
      const s = new _Map.default(registry, _Text.default, _U.default, input);
  ...
  describe('encoding', () => {
    const testEncode = (to, expected) => it(`can encode ${to}`, () => {
      const s = new _Map.default(registry, _Text.default, _U.default, mockU32TextMap, 'BTreeMap');
  ...
  describe('encoding muple values', () => {
    const testEncode = (to, expected) => it(`can encode ${to}`, () => {
      const s = new _Map.default(registry, _Text.default, _U.default, mockU32U32Map, 'BTreeMap');
      expect(s[to]()).toEqual(expected);
    });
