...
class LookupSource extends _Base.default {
  ...
  static _decodeAddress(registry, value) {
    return value instanceof LookupSource ? value._raw : value instanceof _AccountId.default || value instanceof _AccountIndex.default ? value : (0, _util.isBn)(value) || (0, _util.isNumber)(value) || (0, _util.isBigInt)(value) ? registry.createType('AccountIndex', value) : Array.isArray(value) || (0, _util.isHex)(value) || (0, _util.isU8a)(value) ? decodeU8a(registry, (0, _util.u8aToU8a)(value)) : decodeString(registry, value);
  }
  /**
