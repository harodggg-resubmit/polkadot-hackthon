...
class Mock {
  ...
  init() {
    ...
    let counter = -1;
    const metadata = new _metadata.default(this.registry, _static.default);
    this.registry.setMetadata(metadata);
    const query = (0, _metadata.storageFromMeta)(this.registry, metadata); // Do something every 1 seconds
